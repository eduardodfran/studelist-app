...
document.addEventListener('DOMContentLoaded', async () => {
  try {
    ...
    const notesResponse = await fetch(
      'http://studelist-app-api.vercel.app/api/notes/summary',
      { headers }
    )
    ...
    const todoResponse = await fetch(
      'http://studelist-app-api.vercel.app/api/todo/summary',
      { headers }
    )
    ...
    const eventsResponse = await fetch(
      'http://studelist-app-api.vercel.app/api/events/summary',
      { headers }
    )
